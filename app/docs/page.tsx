    ...
    render: (endpoint) => (
      <div className="space-y-3">
        <div className="flex flex-wrap items-center gap-3">
          <span className="inline-flex items-center rounded-full bg-gray-900 px-2.5 py-1 text-xs font-semibold tracking-wide text-white uppercase">
            {endpoint.method}
          </span>
      ...
      <div className="mx-auto max-w-5xl px-6 py-16 lg:px-8">
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Explore the core REST and WebSocket surfaces that power Via Browser.
            Use the live JSON endpoints to integrate programmatically or skim
            the tables below for quick copy-ready payloads.
          </p>
        ...
        <section className="space-y-6">
          <DataTable
            ...
            description={
              <span>
                Stateless operations for screenshots, PDFs, content extraction,
                and structured scraping.
              </span>
            }
            items={restEndpoints}
        ...
        <section className="mt-12 space-y-6">
          <DataTable
            ...
            description={
              <span>
                Persistent browser sessions with DevTools-level control. Connect
                via Playwright or Puppeteer using the URLs below.
              </span>
            }
        ...
        <section className="mt-16 rounded-2xl border border-blue-100 bg-blue-50 px-6 py-8">
          ...
          <p className="mt-3 text-sm text-blue-900">
            Prefer typed metadata? Fetch the JSON catalogs directly from your
            workflow and keep your integrations in sync.
          </p>
