      ...
      <Section title="🎯 Core Architecture & Service Models" id="service-models">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              <tr>
                <td className="border-b py-2 font-semibold">CDP-Based API</td>
              ...
              <tr>
                <td className="border-b py-2 font-semibold">Browsers as a Service (BaaS)</td>
              ...
              <tr>
                <td className="border-b py-2 font-semibold">REST APIs</td>
              ...
              <tr>
                <td className="border-b py-2 font-semibold">AI Agent SDK</td>
...
async function createLiveSession() {
  ...
  -o output.pdf`}
        ...
        <SubSection title="Capture Screenshot">
          <CodeBlock language="bash">
  ...
  persistent: true
      ...
      <Section title="📚 Additional Resources" id="additional-resources">
        <ul className="list-disc list-inside space-y-1">
          <li>
            ...
            <a className="text-blue-600 underline" href="https://github.com/likhon29jan/via-browser">
              https://github.com/likhon29jan/via-browser
            </a>
          </li>
          <li>
            <strong>Live Platform</strong>: 
            <a className="text-blue-600 underline" href="https://viabrowserai.vercel.app/">
              https://viabrowserai.vercel.app/
            </a>
          </li>
          <li>
            <strong>API Documentation</strong>: 
            <a className="text-blue-600 underline" href="https://viabrowserai.vercel.app/docs">
              https://viabrowserai.vercel.app/docs
            </a>
          </li>
          <li>
            <strong>Discord Community</strong>: <a className="text-blue-600 underline" href="#">Join our community</a>
          </li>
          <li>
            ...
            >
              https://github.com/likhon29jan/via-browser/tree/main/examples
            </a>
          </li>
        </ul>
      </Section>
      ...
      <Section title="🤝 Contributing" id="contributing">
        <p>
          ...
          <a className="text-blue-600 underline" href="https://github.com/likhon29jan/via-browser/blob/main/CONTRIBUTING.md">
            Contributing Guide
          </a> 
          to get started.
        </p>
      ...
      <Section title="📄 License" id="license">
        <p>
          ...
          <a className="text-blue-600 underline" href="https://github.com/likhon29jan/via-browser/blob/main/LICENSE">
            LICENSE
          </a> 
          for details.
        </p>
