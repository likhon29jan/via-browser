              ...
              agents: [
                {
                  ...
                  prompt: "Capture onboarding flow screenshots and key friction points."
                }
              ]
            }
          ],
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        requestExample: {
          query: "MATCH (product)-[r:MENTIONED_IN]->(page) WHERE product.category = $category RETURN product, COUNT(r) as mentions",
          parameters: {
            category: "laptops"
          },
          freshnessMinutes: 30
